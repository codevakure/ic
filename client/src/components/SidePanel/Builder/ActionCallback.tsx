...
import { AuthTypeEnum } from 'ranger-data-provider';
          ...
          <div className="flex-1 overflow-hidden">
            <div className="relative w-full">
              <input
                ...
                readOnly
                value={callbackURL}
                className="w-full border-0 bg-transparent px-3 py-2 pr-12 text-sm text-text-secondary-alt direction-rtl focus:outline-none"
              />
            </div>
          </div>

...
import { Label, Checkbox, Spinner, useToastContext } from '@ranger/client';
import type { MCP } from 'ranger-data-provider';
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-end">
        <button
          onClick={saveMCP}
          disabled={isLoading}
          className="focus:shadow-outline mt-1 flex min-w-[100px] items-center justify-center rounded bg-surface-submit px-4 py-2 font-semibold text-white hover:bg-surface-submit-hover focus:border-blue-500 focus:outline-none focus:ring-0 disabled:opacity-50"
          type="button"
        >
          {(() => {
            if (isLoading) {

...
This directory contains comprehensive Redis configuration files and scripts for Ranger development and testing, supporting both cluster and single-node setups with optional TLS encryption.
...
REDIS_CA=/path/to/Ranger/redis-config/certs/ca-cert.pem
```
...
ls -la /path/to/Ranger/redis-config/certs/ca-cert.pem

# Test Ranger Redis configuration
cd /path/to/Ranger
npm run backend
...
- [Ranger Documentation](https://github.com/TexasCapitalDevelopment/coretex.ai.technology.enterprise-chat)
...
function _mergeOptions(_options: object) {
  const defaultOptions = {
    digit: true, // [comment removed]
    alpha: true, // [comment removed]
    space: true, // [comment removed]
    symbol: true, // [comment removed]
    punctuation: false, // [comment removed]
    smartMode: true // [comment removed]
  };

import { EModelEndpoint, agentsEndpointSchema } from 'ranger-data-provider';
import type { TCustomConfig, TAgentsEndpoint } from 'ranger-data-provider';

/**
 * Sets up the Agents configuration from the config (`ranger.yaml`) file.

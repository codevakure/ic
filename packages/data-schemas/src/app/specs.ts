...
import { EModelEndpoint, normalizeEndpointName } from 'ranger-data-provider';
import type { TCustomConfig } from 'ranger-data-provider';

/**
 * Sets up Model Specs from the config (`ranger.yaml`) file.
...
For more information, see the documentation at https://ranger.tcbinternal.net/docs/configuration/ranger_yaml/object_structure/model_specs#endpoint`);
      continue;
    }

import { EModelEndpoint, getConfigDefaults } from 'ranger-data-provider';
import type { TCustomConfig, FileSources, DeepPartial } from 'ranger-data-provider';
...
export const AppService = async (params?: {
  ...
  const defaultConfig = {
    ...
    intentAnalyzer: config.intentAnalyzer,
  };

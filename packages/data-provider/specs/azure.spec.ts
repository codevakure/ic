...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'ranger-westus'
    expect(groupMap).toHaveProperty('ranger-westus');
    expect(groupMap['ranger-westus']).toEqual(
    ...
    // Check groupMap for 'ranger-eastus'
    expect(groupMap).toHaveProperty('ranger-eastus');
    expect(groupMap['ranger-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'ranger-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'ranger-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'ranger-eastus',

...
export const ranger = {
  modelLabel: {
    ...
    labelCode: true,
    description: 'com_endpoint_openai_custom_name_desc',
    descriptionCode: true,
    type: 'string',
    default: '',
    component: 'input',
  ...
  promptPrefix: {
    ...
    labelCode: true,
    description: 'com_endpoint_openai_prompt_prefix_desc',
    descriptionCode: true,
    type: 'string',
    default: '',
    component: 'textarea',
...
const openAIParams: Record<string, SettingDefinition> = {
  ...
  promptPrefix: ranger.promptPrefix,

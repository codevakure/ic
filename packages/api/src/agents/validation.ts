import { z } from 'zod';
import { ViolationTypes, ErrorTypes } from 'ranger-data-provider';
import type { Agent, TModelsConfig } from 'ranger-data-provider';
...
export const agentCreateSchema = agentBaseSchema.extend({
  ...
  tool_credentials: z.record(z.record(z.string())).optional().default({}),
});
...
export const agentUpdateSchema = agentBaseSchema.extend({
  ...
  tool_credentials: z.record(z.record(z.string())).optional(),

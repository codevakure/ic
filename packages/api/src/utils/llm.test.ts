import { extractRangerParams } from './llm';

describe('extractRangerParams', () => {
  it('should return defaults when options is undefined', () => {
    const result = extractRangerParams(undefined);
  ...
  it('should return defaults when options is null', () => {
    const result = extractRangerParams();
  ...
  it('should extract all Ranger params and leave model options', () => {
    const options = {
      resendFiles: false,
    ...
    const result = extractRangerParams(options);
  ...
  it('should handle null values for Ranger params', () => {
    const options = {
      resendFiles: true,
      promptPrefix: null,
  ...
  it('should only extract known Ranger params', () => {
    const options = {
      resendFiles: false,
  ...
  it('should not mutate the original options object', () => {
    ...
    extractRangerParams(options);

    // Original object should remain unchanged
    expect(options).toEqual(originalOptions);
  });

  it('should handle undefined values for optional Ranger params', () => {
    const options = {
      resendFiles: false,

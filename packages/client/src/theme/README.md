# Dynamic Theme System for @ranger/client
...
```bash
npm install @ranger/client
```

### 2. Wrap Your App with ThemeProvider

```tsx
import { ThemeProvider } from '@ranger/client';
...
module.exports = {
  content: [
    ...
    './node_modules/@ranger/client/dist/**/*.js',
  ],
  darkMode: ['class'],
  theme: {
    extend: {
...
```tsx
import { IThemeRGB } from '@ranger/client';
...
```tsx
import { useTheme } from '@ranger/client';
...
**After:**
```tsx
import { ThemeContext, ThemeProvider } from '@ranger/client';
```
...
```tsx
import { ThemeProvider, defaultTheme, darkTheme } from '@ranger/client';
...
This theme system is part of the @ranger/client package. 
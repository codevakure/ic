...
const { loadYaml } = require('@ranger/api');
...
const defaultConfigPath = path.resolve(projectRoot, 'ranger.yaml');
...
https://ranger.tcbinternal.net/docs/configuration/stt_tts`);
      }

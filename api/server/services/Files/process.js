...
const { EnvVar } = require('illuma-agents');
const { logger } = require('@ranger/data-schemas');
const { sanitizeFilename, parseText, processAudioFile } = require('@ranger/api');
const { analyzeUploadIntent, UploadIntent } = require('@ranger/intent-analyzer');
const {
  convertImage,
  resizeAndConvert,
  resizeImageBuffer,
 ...
 * @param {RunClient} params.client - The Ranger client instance: either refers to `openai` or `streamRunManager`.
 * @param {string} params.file_id - The ID of the file to retrieve.

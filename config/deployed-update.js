...
(async () => {
  ...
  console.purple('Removing all tags for Ranger `deployed` images...');
  const repositories = ['ghcr.io/TexasCapitalDevelopment/ranger-dev-api', 'ranger-client'];
  ...
  console.purple('Pulling latest Ranger images...');

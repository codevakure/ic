...
/**
 * Ranger Cache Flush Utility
 *
 * This script flushes the cache store used by Ranger, whether it's
...
DESCRIPTION:
  Flushes the cache store used by Ranger. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the Ranger backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 Ranger Cache Flush Utility');
  console.log('================================');
